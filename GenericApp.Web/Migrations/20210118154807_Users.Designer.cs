...
namespace GenericApp.Web.Migrations
{
    ...
    [Migration("20210118154807_Users")]
    partial class Users
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GenericApp.Web.Data.Entities.CategoryEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("GenericApp.Web.Data.Entities.ProductEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("GenericApp.Web.Data.Entities.ProductImageEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("GenericApp.Web.Data.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("GenericApp.Web.Data.Entities.ProductEntity", b =>
                {
                    b.HasOne("GenericApp.Web.Data.Entities.CategoryEntity", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("GenericApp.Web.Data.Entities.ProductImageEntity", b =>
                {
                    b.HasOne("GenericApp.Web.Data.Entities.ProductEntity")
            ...
            modelBuilder.Entity("GenericApp.Web.Data.Entities.User", b =>
                {
                    b.HasOne("GenericApp.Web.Data.Entities.CityEntity", "City")
                        .WithMany()
                        .HasForeignKey("CityId");

                    b.HasOne("GenericApp.Web.Data.Entities.TeamEntity", "FavoriteTeam")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GenericApp.Web.Data.Entities.User")
                        .WithMany()
