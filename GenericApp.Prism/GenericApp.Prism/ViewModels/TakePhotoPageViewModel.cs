...
namespace GenericApp.Prism.ViewModels
{
    public class TakePhotoPageViewModel : ViewModelBase
    {
        ...
        public TakePhotoPageViewModel(INavigationService navigationService, IApiService apiService, IFilesHelper filesHelper, IGeolocatorService geolocatorService) : base(navigationService)
        {
